...
from AudioHash.database import Database
...
class SQLDatabase(Database):
    ...
    def setup(self):
        """
        Creates any non-existing tables required for AudioHash to function.
    ...
    def empty(self):
        """
        Drops tables created by AudioHash and then creates them again
